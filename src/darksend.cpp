...
{
    if(fLiteMode) return; // ignore all PlatoPay related functionality
...
/*
    ...
    allow endless transaction that would bloat PlatoPay and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("platopay-privatesend");
