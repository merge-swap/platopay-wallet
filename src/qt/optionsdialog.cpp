    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PPX-light"), QVariant("light"));
    ui->theme->addItem(QString("PPX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PPX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PPX-traditional"), QVariant("trad"));
