    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("PlatoPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PlatoPay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and platopay: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About PlatoPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about PlatoPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PlatoPay Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PlatoPay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PlatoPay addresses"));
    ...
    openAction->setStatusTip(tr("Open a platopay: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PlatoPay Core help message to get a list with possible PlatoPay Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("PlatoPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PlatoPay network", "", count));
}
...
{
    QString strTitle = tr("PlatoPay Core"); // default title
