/* src/config/platopay-config.h.  Generated from platopay-config.h.in by configure.  */
/* src/config/platopay-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PLATOPAY_CONFIG_H

#define PLATOPAY_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/platopaycoin/platopay/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PlatoPay Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PlatoPay Core 0.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "platopaycore"
