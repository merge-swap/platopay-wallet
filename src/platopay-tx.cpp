...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("PlatoPay Core platopay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  platopay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded platopay transaction") + "\n" +
              "  platopay-tx [options] -create [commands]   " + _("Create hex-encoded platopay transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded platopay transaction
