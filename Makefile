...
pkgdatadir = $(datadir)/platopaycore
pkgincludedir = $(includedir)/platopaycore
pkglibdir = $(libdir)/platopaycore
pkglibexecdir = $(libexecdir)/platopaycore
...
CONFIG_HEADER = $(top_builddir)/src/config/platopay-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/platopay-config.h.in \
...
ACLOCAL = ${SHELL} /home/alex/Documents/Plato/platopay-lin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/alex/Documents/Plato/platopay-lin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/alex/Documents/Plato/platopay-lin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/alex/Documents/Plato/platopay-lin/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/alex/Documents/Plato/platopay-lin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = platopaycore
PACKAGE_BUGREPORT = https://github.com/platopaycoin/platopay/issues
PACKAGE_NAME = PlatoPay Core
PACKAGE_STRING = PlatoPay Core 0.0.0
PACKAGE_TARNAME = platopaycore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/alex/Documents/Plato/platopay-lin
abs_srcdir = /home/alex/Documents/Plato/platopay-lin
abs_top_builddir = /home/alex/Documents/Plato/platopay-lin
abs_top_srcdir = /home/alex/Documents/Plato/platopay-lin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/alex/Documents/Plato/platopay-lin/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/platopayd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/platopay-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/platopay-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = PlatoPay-Qt.app
OSX_DMG = PlatoPay-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_platopay_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_platopay_coverage.info test_platopay.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/PlatoPay-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/platopay-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/platopay-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/platopay-config.h
$(top_srcdir)/src/config/platopay-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/platopay-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/PlatoPay-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/PlatoPay-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "PlatoPay-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/PlatoPay-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_platopay.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_platopay -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_platopay_filtered.info: test_platopay.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_platopay_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_platopay_filtered.info
...
#test_platopay_coverage.info: baseline_filtered_combined.info test_platopay_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_platopay_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_platopay_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_platopay_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_platopay.coverage/.dirstamp:  test_platopay_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_platopay.coverage/.dirstamp total.coverage/.dirstamp

# PlatoPay: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_platopay.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
