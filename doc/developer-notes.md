...
PlatoPay Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as PlatoPay Core, where everyone uses
...
pay attention to for reviewers of PlatoPay Core code.

General PlatoPay Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: PlatoPay Core uses tinyformat, which is type safe. Leave them out to avoid confusion
