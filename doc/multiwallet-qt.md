...
Only requiring some minor changes is platopay.cpp.
...
Changes to platopay.cpp
----------------------
platopay.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
