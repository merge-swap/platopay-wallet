...
This mechanism has been integrated into Bitcore-Node-PlatoPay which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/platopaycoin/insight-api-platopay#web-socket-api](https://github.com/platopaycoin/insight-api-platopay#web-socket-api) 
* API: [https://github.com/platopaycoin/insight-api-platopay#instantsend-transactions](https://github.com/platopaycoin/insight-api-platopay#instantsend-transactions) 
...
By default, the PlatoPay Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PlatoPay Core daemon:
